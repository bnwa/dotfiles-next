...
---@param ls T[]
---@param f fun(x: T): boolean
---@return number | false, T | nil
function M.find(ls, f)
...
---Mutate list to remove `query` if it exists,
---returning true if it was removed, and false otherwise.
---@generic T
---@param ls T[]
---@param query T
---@return boolean
function M.remove(ls, query)
  for i,x  in pairs(ls) do
    if x == query then
      table.remove(ls, i)
      return true
