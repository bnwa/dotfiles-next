...
opt.foldcolumn = '0' -- Always hide fold column
opt.foldenable = false
opt.foldexpr = 'nvim_treesitter#foldexpr()'
opt.foldlevel = 99 -- Init bufs with all folds open
opt.foldlevelstart = 99 -- Init bufs with all folds open
opt.foldmethod = 'expr'
opt.gdefault = true
...
opt.shiftwidth = 4 -- Value of indent ops
...
opt.tabstop = 4 -- Value of <TAB> in spaces
